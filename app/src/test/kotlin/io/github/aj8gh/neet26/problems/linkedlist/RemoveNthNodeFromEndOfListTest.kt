...
class RemoveNthNodeFromEndOfListTest : FunSpec({
  withTests(
    Triple(linkedListOf(1, 2, 3), 2, linkedListOf(1, 3)),
    Triple(linkedListOf(1, 2), 1, linkedListOf(1)),
    Triple(linkedListOf(1, 2, 3, 4), 2, linkedListOf(1, 2, 4)),
    Triple(linkedListOf(1, 2, 3, 4), 4, linkedListOf(2, 3, 4)),
    Triple(linkedListOf(1, 2), 2, linkedListOf(2)),
